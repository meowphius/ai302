...
package body AI302.Containers.Hashed_Maps is
      ...
      function New_Node
        (Next : Node_Access) return Node_Access is
         ...
         Node : constant Node_Access :=
            new Node_Type'(Key, New_Item, Next);
      begin
         return Node;
      end;
   ...
   procedure Insert (Map      : in out Map_Type;
      ...
      function New_Node
        (Next : Node_Access) return Node_Access is
         ...
         Node : Node_Access := new Node_Type;  --fix this in Ada 0Y
      begin
         Node.Key := Key;
         Node.Next := Next;
