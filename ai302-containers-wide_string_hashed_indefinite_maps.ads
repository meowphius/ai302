...
with AI302.Strings.Wide_Hash;

generic

   type Element_Type (<>) is private;

   with function Hash (Key : Wide_String)
     return Hash_Type is AI302.Strings.Wide_Hash;

   with function Is_Equal_Key (Left, Right : Wide_String)
      return Boolean is "=";

   with function "=" (Left, Right : Element_Type)
      return Boolean is <>;

package AI302.Containers.Wide_String_Hashed_Indefinite_Maps is
   pragma Preelaborate (Wide_String_Hashed_Indefinite_Maps);

   subtype Key_Subtype is Wide_String;
   ...
   function Key (Cursor : Cursor_Type) return Wide_String;
...
end AI302.Containers.Wide_String_Hashed_Indefinite_Maps;
