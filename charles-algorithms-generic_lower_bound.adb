...
function Charles.Algorithms.Generic_Lower_Bound
  (First, Back : Iterator_Type;
   ...
   I : Difference_Type'Base := Back - First;
   J : Difference_Type'Base;
...
begin
   ...
   while I > Difference_Type'Base'(0) loop

      J := I / Difference_Type'Base'(2);

      Middle := Iterator + J;

      if Is_Less (Middle, Item) then

         Iterator := Middle + Difference_Type'Base'(1);

         I := I - J - Difference_Type'Base'(1);
